        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  This prediction model uses a fine-tuned Keras EfficientNet model. It can identify 10 different animal species: Dog, Cat, Horse, Spider, Butterfly, Chicken, Sheep, Cow, Squirrel, and Elephant with high accuracy.
                </p>
              </CardContent>
            </Card>
          </div>
